...
1. Cloner le repo avec `git clone https://github.com/Airiers/jarvis-kernel`
...
La procédure d'installation d'un module est relativement simple :
...
- Le fichier doit avoir une classe `Main` **avec un "M" majuscule**
- Les méthodes de la classe `Main` doivent être statiques
